...
אינדקסים: התקפה 58 · הגנה 53 (→**51 ל-MD2 אם Ndicka בחוץ**) · מאמן cq1.02 cs0.0 · עדכון: 20.6.26
> **עדכון 20.6 (לקראת גרמניה):** **Ndicka (בלם מפתח, רומא) ספק-פציעה (ירך)** → Agbadou (Wolves) צפוי להחליף → הגנה 53→**51** למשחק זה. Wahi לא-זמין (לא פציעה). מול גרמניה צפוי בלוק נמוך + קאונטר (Amad/Adingra) — Faé cs0.0→**−0.2** למשחק.
